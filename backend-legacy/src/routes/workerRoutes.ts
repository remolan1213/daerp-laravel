...
import { validateWorkerPayload } from "../middleware/validate";

const router:Router = express.Router();

// Worker Routes
router.post("/", validateWorkerPayload, createWorker); // createWorker
...
router.put("/:idNumber", validateWorkerPayload, updateWorker); // updateWorker
