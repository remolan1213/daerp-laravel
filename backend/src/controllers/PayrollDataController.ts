...
export const getAllPayrollData = async (req: Request, res: Response) => {
  try {
...
export const createPayrollData = async (req: Request, res: Response) => {
  try {
...
export const getPayrollDataById = async (req: Request, res: Response) => {
  const { id } = req.params;
  try {
...
export const updatePayrollData = async (req: Request, res: Response) => {
  const { id } = req.params;
  try {
...
export const deletePayrollData = async (req: Request, res: Response) => {
  const { id } = req.params;
  try {
    const payrollDataRepository = AppDataSource.getRepository(PayrollData);
    const payrollData = await payrollDataRepository.findOne({ where: { id: Number(id) } });
