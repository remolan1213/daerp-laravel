...
import { createCashAdvance, getAllCashAdvances, getCashAdvanceById, updateCashAdvance, deleteCashAdvance, } from '../controllers/CashAdvanceController.js';
import { createCashAdvanceDate, getAllCashAdvanceDates, getCashAdvanceDateById, updateCashAdvanceDate, deleteCashAdvanceDate, } from '../controllers/CashAdvanceDatesController.js';
const router = Router();
// Cash Advance Routes
